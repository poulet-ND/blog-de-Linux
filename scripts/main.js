...
function setUserName() {
  ...
  if (!myName) {
    ...
    myHeading.textContent = `Cher ${myName}, voici comment installer Linux à côté de Windows`;
  }
}
...
//   setUserName();
  ...
  myHeading.textContent = `Cher ${storedName}, voici comment installer Linux à côté de Windows`;
}
